<template>
  ...
  <v-footer class="footer">
    <v-container>
      <v-row class="py-0 justify-space-between py-md-15">
        <!-- -----------------------------------------------
        First Column
      ----------------------------------------------- -->
      ...
      ----------------------------------------------- -->
        <v-col cols="12" sm="12" md="12" lg="3" class="px-xs-0">
          ...
          <p class="mt-0 mb-0">Phone : +91 7011 5878 32 </p>
          <p class="mt-5 mb-0">Email : pulkitsingh302@gmail.com </p>
      ...
      <div class="footer-bottom-bar font-14">
        <div class="d-block d-md-flex text-center align-center">
          <p>
            All Rights Reserved by
            <a href="https://www..com/" class="link"> Pulkit Singh </a>
          </p>
          <!-- <div class="ml-auto">
